...
import { getCharacterById, updateCharacter, Character } from '@/lib/characters';
      ...
      return (
        <div className="flex h-screen w-full items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <h2 className="text-xl font-semibold">กำลังโหลดข้อมูลตัวละคร...</h2>
